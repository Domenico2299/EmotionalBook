...
public class FragmentYear extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        seekBar1.setProgress(DatabaseManager.valYear[0].intValue());
        seekBar2.setProgress(DatabaseManager.valYear[1].intValue());
        seekBar3.setProgress(DatabaseManager.valYear[2].intValue());
        seekBar4.setProgress(DatabaseManager.valYear[3].intValue());
